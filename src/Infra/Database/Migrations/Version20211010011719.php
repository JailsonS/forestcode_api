...
final class Version20211010011719 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE Farm (id SERIAL NOT NULL, municipality_id INT DEFAULT NULL, name VARCHAR(150) NOT NULL, area DOUBLE PRECISION DEFAULT NULL, mf DOUBLE PRECISION DEFAULT NULL, geom geometry(POLYGON, 4674) NOT NULL, PRIMARY KEY(id))');
